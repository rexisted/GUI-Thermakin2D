...
global cmp_created cnd_created tk2d_created out_created
...
function start_pshbttn_Callback(hObject, eventdata, handles)
%%
global cmp_created cnd_created tk2d_created out_created questVal
questVal = 0;
%%
if cmp_created == 0
    imshow('cross.png','Parent',handles.intro_chckbx_cmp)
...
elseif cmp_created == 1 && cnd_created == 0
    imshow('check.png','Parent',handles.intro_chckbx_cmp)

    cnd_fig = figure(...
        'Color',[.94 .94 .94],...
        'Position',[500,500,165,250],...
        'Resize','Off',...
        'MenuBar','none',...
        'Name','Conditions',...
        'CloseRequestFcn',@closereq,...
...
elseif cnd_created == 1 && cmp_created == 1 && tk2d_created == 0
    imshow('check.png','Parent',handles.intro_chckbx_cnd)
    
elseif cnd_created == 1 && cmp_created == 1 && tk2d_created == 1 && out_created == 0
    imshow('check.png','Parent',handles.intro_chckbx_tk2d)
    
elseif cnd_created == 1 && cmp_created == 1 && tk2d_created == 1 && out_created == 1
    imshow('check.png','Parent',handles.intro_chckbx_out)
end
%% $$$$$$$$$$$$$$$$$ COMPONENT GUI $$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$
...
%% =============== IMPORT COMPONENT =======================================
function cmp_import_pshbttn_callback(~, ~, ~)
%%
...
if isequal(FileName,0) %if no file is chosen or canceled then display Cancel
    ...
    start_pshbttn = findobj('Tag','start_pshbttn');
    start_pshbttn.String = 'Next Step';
    start_pshbttn.TooltipString = 'Conditions';
    cnd_button = findobj('Tag','cnd_button');
    cnd_button.Enable = 'on';
    
end

%% =============== CUSTOM COMPONENT GUI ===================================
function cmp_custom_pshbttn_Callback(~, ~, ~)
delete(gcf)
%% Global variables
global cmp_custom_figure... %Contains the guidata of the custom cmp gui
    ...
    cmp_mixprop_paratrans_edt questVal
...
function cmp_crte_pshbttn_callback(~, ~, ~)
%%
global cmp_cmp_lst...
    cmp_mixprop_sswel_edt...
    cmp_mixprop_lswel_edt...
...
%% =================== LIFT ===============================================
function cnd_lift_pshbttn_callback(~, ~, ~)
close(gcf)
%% Object structure
% Thickness
...
%% ======================== CONDITION CUSTOM ==============================
function cnd_custom_pshbttn_callback(~, ~, ~)
%%
close(gcf)
...
global cnd_custom_fig...
    ...
    cmp_filename questVal

questVal = 1;

%Retrieving gases of materials
%% Components
global cmpname_list cmpgas_list
...
%% Buttons
cnd_dimselect_mn = uicontrol(...
    'Parent',cnd_custom_fig,...
    'Position',[80 450 100 30],...
    'String',['1D            ';'1D Axisymetric';'2D            ';'2D Axisymetric'],...
    'Style','popupmenu',...
    'Tag','cnd_objstrct_mn',...
    'TooltipString','Default');
...
global tp_mt_val tp_imf_val...
    bb_mt_val bb_imf_val objstrctVal
...
function cnd_tpbnd_msstrns_mn1_callback(~, ~, ~)
%%
global cnd_tpbnd_msstrns_mn1 cnd_tpbnd_msstrns_txt...
    cnd_tpbnd_addmt_pshbttn cnd_tpbnd_remmt_pshbttn...
    tp_mt_val cnd_tpbnd_inpnl cnd_tpbnd_scrll_sldr
...
if list_select == 2
    ...
    %Positioning
    cnd_tpbnd_msstrns_txt.Position = cnd_tpbnd_msstrns_txt.Position - [0 mt_pos 0 0];
    cnd_tpbnd_msstrns_mn1.Position = cnd_tpbnd_msstrns_mn1.Position - [0 mt_pos 0 0];
    cnd_tpbnd_inpnl.Position = cnd_tpbnd_inpnl.Position - [0 -mt_pos 0 mt_pos];
...
cnd_tpbnd_inpnl.Units = 'pixels';
function cnd_tpbnd_addmt_pshbttn_callback(~, ~, ~)
%% Variables
global cnd_tpbnd_scrll_sldr tp_mt_val cmpgas_list...
    cnd_tpbnd_inpnl cnd_tpbnd_remmt_pshbttn...
    cnd_tpbnd_msstrns_txt cnd_tpbnd_msstrns_mn1
%% Create New Mass Transport input
if tp_mt_val < size(cmpgas_list,1)
    if tp_mt_val == 1
        cnd_tpbnd_remmt_pshbttn.Enable = 'on';
        cnd_tpbnd_remmt_pshbttn.Visible = 'On';
    end
    cnd_tpbnd_msstrns_mn2 = findobj(...
    ...
    cnd_tpbnd_inpnl.Units = 'normalized';
    cnd_tpbnd_scrll_sldr.Max = cnd_tpbnd_inpnl.Position(4) - 1;
    cnd_tpbnd_scrll_sldr.Value = -cnd_tpbnd_inpnl.Position(2);
    cnd_tpbnd_inpnl.Units = 'pixels';
end
function cnd_tpbnd_remmt_pshbttn_callback(~, ~, ~)
%%
global cnd_tpbnd_inpnl cnd_tpbnd_remmt_pshbttn...
    cnd_tpbnd_msstrns_txt cnd_tpbnd_msstrns_mn1...
    tp_mt_val cnd_tpbnd_scrll_sldr
%%
if tp_mt_val > 1
    cnd_tpbnd_msstrns_mn2 = findobj(...
        'Tag',(sprintf('cnd_tpbnd_msstrns_mn2_%d',tp_mt_val)));
    ...
    if tp_mt_val == 1
        cnd_tpbnd_remmt_pshbttn.Enable = 'off';
        cnd_tpbnd_remmt_pshbttn.Visible = 'Off';
    end
    %% Position
    shift_val = -24;
...
function cnd_tpbnd_exrd_mn_callback(~, ~, ~)
%%
global cnd_tpbnd_exrd_mn cnd_tpbnd_inpnl...
    cnd_tpbnd_msstrns_mn1 cnd_tpbnd_msstrns_txt...
    cnd_tpbnd_addmt_pshbttn cnd_tpbnd_remmt_pshbttn...
    cnd_tpbnd_outtmptimep_txt cnd_tpbnd_outtmptimep_edt1...
    cnd_tpbnd_outtmptimep_edt2...
    cnd_tpbnd_convcoeff1_txt cnd_tpbnd_convcoeff1_edt...
    ...
    cnd_tpbnd_rpt_txt cnd_tpbnd_rpt_mn...
    cnd_tpbnd_absrpmd_txt cnd_tpbnd_absrpmd_mn...
    cnd_tpbnd_scrll_sldr tp_mt_val cnd_tpbnd_expnl
%% Hide and Show based on selected value
...
if list_select == 1;
    ...
    % Positioning
    cnd_tpbnd_msstrns_txt.Position =...
        cnd_tpbnd_msstrns_txt.Position + [0 exra_pos 0 0];
    cnd_tpbnd_msstrns_mn1.Position =...
        cnd_tpbnd_msstrns_mn1.Position + [0 exra_pos 0 0];
    ...
    for i = 1:tp_mt_val;
        ...
        cnd_tpbnd_msstrns_mn2.Position =...
            cnd_tpbnd_msstrns_mn2.Position + [0 exra_pos 0 0];
        cnd_tpbnd_msstrns_mn3.Position =...
            cnd_tpbnd_msstrns_mn3.Position + [0 exra_pos 0 0];
        cnd_tpbnd_msstrns_edt1.Position =...
            cnd_tpbnd_msstrns_edt1.Position + [0 exra_pos 0 0];
        cnd_tpbnd_msstrns_edt2.Position =...
            cnd_tpbnd_msstrns_edt2.Position + [0 exra_pos 0 0];
    end
    
    cnd_tpbnd_addmt_pshbttn.Position =...
        cnd_tpbnd_addmt_pshbttn.Position + [0 exra_pos 0 0];
    cnd_tpbnd_remmt_pshbttn.Position =...
        cnd_tpbnd_remmt_pshbttn.Position + [0 exra_pos 0 0];
    cnd_tpbnd_outtmptimep_txt.Position =...
        cnd_tpbnd_outtmptimep_txt.Position + [0 exra_pos 0 0];
    cnd_tpbnd_outtmptimep_edt1.Position =...
        cnd_tpbnd_outtmptimep_edt1.Position + [0 exra_pos 0 0];
    cnd_tpbnd_outtmptimep_edt2.Position =...
        cnd_tpbnd_outtmptimep_edt2.Position + [0 exra_pos 0 0];
    cnd_tpbnd_convcoeff1_txt.Position =...
        cnd_tpbnd_convcoeff1_txt.Position + [0 exra_pos 0 0];
    cnd_tpbnd_convcoeff1_edt.Position =...
        cnd_tpbnd_convcoeff1_edt.Position + [0 exra_pos 0 0];
    cnd_tpbnd_exrd_txt.Position =...
        cnd_tpbnd_exrd_txt.Position + [0 exra_pos 0 0];
    cnd_tpbnd_exrd_mn.Position =...
        cnd_tpbnd_exrd_mn.Position + [0 exra_pos 0 0];
    cnd_tpbnd_inpnl.Position =...
        cnd_tpbnd_inpnl.Position + [0 -exra_pos 0 exra_pos];
...
elseif list_select == 2;
    ...
    % Positioning
    cnd_tpbnd_msstrns_txt.Position = cnd_tpbnd_msstrns_txt.Position - [0 exra_pos 0 0];
    cnd_tpbnd_msstrns_mn1.Position = cnd_tpbnd_msstrns_mn1.Position - [0 exra_pos 0 0];
    ...
    cnd_tpbnd_addmt_pshbttn.Position = cnd_tpbnd_addmt_pshbttn.Position - [0 exra_pos 0 0];
    cnd_tpbnd_remmt_pshbttn.Position = cnd_tpbnd_remmt_pshbttn.Position - [0 exra_pos 0 0];
    cnd_tpbnd_outtmptimep_txt.Position = cnd_tpbnd_outtmptimep_txt.Position - [0 exra_pos 0 0];
    cnd_tpbnd_outtmptimep_edt1.Position = cnd_tpbnd_outtmptimep_edt1.Position - [0 exra_pos 0 0];
    cnd_tpbnd_outtmptimep_edt2.Position = cnd_tpbnd_outtmptimep_edt2.Position - [0 exra_pos 0 0];
    cnd_tpbnd_convcoeff1_txt.Position = cnd_tpbnd_convcoeff1_txt.Position - [0 exra_pos 0 0];
    cnd_tpbnd_convcoeff1_edt.Position = cnd_tpbnd_convcoeff1_edt.Position - [0 exra_pos 0 0];
    cnd_tpbnd_exrd_txt.Position = cnd_tpbnd_exrd_txt.Position - [0 exra_pos 0 0];
    cnd_tpbnd_exrd_mn.Position = cnd_tpbnd_exrd_mn.Position - [0 exra_pos 0 0];
    cnd_tpbnd_inpnl.Position = cnd_tpbnd_inpnl.Position - [0 -exra_pos 0 exra_pos];
end
disp(cnd_tpbnd_inpnl.Position);
disp(cnd_tpbnd_expnl.Position);
%% Scroll adjustment
cnd_tpbnd_inpnl.Units = 'normalized';
cnd_tpbnd_scrll_sldr.Max = cnd_tpbnd_inpnl.Position(4) - 1;
cnd_tpbnd_scrll_sldr.Value = 0;
cnd_tpbnd_inpnl.Units = 'pixels';
function cnd_tpbnd_flm_mn_callback(~, ~, ~)
%%
global cnd_tpbnd_inpnl cnd_tpbnd_scrll_sldr...
    cnd_tpbnd_flm_mn tp_imf_val tp_mt_val...
...
if list_select == 1
    ...
    %Positioning
    cnd_tpbnd_msstrns_txt.Position = cnd_tpbnd_msstrns_txt.Position - [0 flm_pos 0 0];
    cnd_tpbnd_msstrns_mn1.Position = cnd_tpbnd_msstrns_mn1.Position - [0 flm_pos 0 0];
    ...
    for i = 1:tp_mt_val;
        ...
        cnd_tpbnd_msstrns_mn2.Position =...
            cnd_tpbnd_msstrns_mn2.Position + [0 flm_pos 0 0];
        cnd_tpbnd_msstrns_mn3.Position =...
            cnd_tpbnd_msstrns_mn3.Position + [0 flm_pos 0 0];
        cnd_tpbnd_msstrns_edt1.Position =...
            cnd_tpbnd_msstrns_edt1.Position + [0 flm_pos 0 0];
        cnd_tpbnd_msstrns_edt2.Position =...
            cnd_tpbnd_msstrns_edt2.Position + [0 flm_pos 0 0];
    end
    
    cnd_tpbnd_addmt_pshbttn.Position =...
        cnd_tpbnd_addmt_pshbttn.Position + [0 flm_pos 0 0];
    cnd_tpbnd_remmt_pshbttn.Position =...
        cnd_tpbnd_remmt_pshbttn.Position + [0 flm_pos 0 0];
    cnd_tpbnd_outtmptimep_txt.Position =...
        cnd_tpbnd_outtmptimep_txt.Position + [0 flm_pos 0 0];
    cnd_tpbnd_outtmptimep_edt1.Position =...
        cnd_tpbnd_outtmptimep_edt1.Position + [0 flm_pos 0 0];
    cnd_tpbnd_outtmptimep_edt2.Position =...
        cnd_tpbnd_outtmptimep_edt2.Position + [0 flm_pos 0 0];
    cnd_tpbnd_convcoeff1_txt.Position =...
        cnd_tpbnd_convcoeff1_txt.Position + [0 flm_pos 0 0];
    cnd_tpbnd_convcoeff1_edt.Position =...
        cnd_tpbnd_convcoeff1_edt.Position + [0 flm_pos 0 0];
    cnd_tpbnd_exrd_txt.Position =...
        cnd_tpbnd_exrd_txt.Position + [0 flm_pos 0 0];
    cnd_tpbnd_exrd_mn.Position =...
        cnd_tpbnd_exrd_mn.Position + [0 flm_pos 0 0];
    cnd_tpbnd_tmprg1_txt.Position =...
        cnd_tpbnd_tmprg1_txt.Position + [0 flm_pos 0 0];
    cnd_tpbnd_tmprg1_edt1.Position =...
        cnd_tpbnd_tmprg1_edt1.Position + [0 flm_pos 0 0];
    cnd_tpbnd_tmprg1_edt2.Position =...
        cnd_tpbnd_tmprg1_edt2.Position + [0 flm_pos 0 0];
    cnd_tpbnd_tmprg1_edt3.Position =...
        cnd_tpbnd_tmprg1_edt3.Position + [0 flm_pos 0 0];
    cnd_tpbnd_tmprg2_txt.Position =...
        cnd_tpbnd_tmprg2_txt.Position + [0 flm_pos 0 0];
    cnd_tpbnd_tmprg2_edt1.Position =...
        cnd_tpbnd_tmprg2_edt1.Position + [0 flm_pos 0 0];
    cnd_tpbnd_tmprg2_edt2.Position =...
        cnd_tpbnd_tmprg2_edt2.Position + [0 flm_pos 0 0];
    cnd_tpbnd_tmprg2_edt3.Position =...
        cnd_tpbnd_tmprg2_edt3.Position + [0 flm_pos 0 0];
    cnd_tpbnd_rpt_txt.Position =...
        cnd_tpbnd_rpt_txt.Position + [0 flm_pos 0 0];
    cnd_tpbnd_rpt_mn.Position =...
        cnd_tpbnd_rpt_mn.Position + [0 flm_pos 0 0];
    cnd_tpbnd_absrpmd_txt.Position =...
        cnd_tpbnd_absrpmd_txt.Position + [0 flm_pos 0 0];
    cnd_tpbnd_absrpmd_mn.Position =...
        cnd_tpbnd_absrpmd_mn.Position + [0 flm_pos 0 0];
    cnd_tpbnd_flm_txt.Position =...
        cnd_tpbnd_flm_txt.Position + [0 flm_pos 0 0];
    cnd_tpbnd_flm_mn.Position =...
        cnd_tpbnd_flm_mn.Position + [0 flm_pos 0 0];
    cnd_tpbnd_inpnl.Position =...
        cnd_tpbnd_inpnl.Position + [0 -flm_pos 0 flm_pos];
...
if le(cnd_tpbnd_inpnl.Position(4),cnd_tpbnd_expnl.Position(4))...
        && gt(cnd_tpbnd_inpnl.Position(2),0);
    pnl_pos = cnd_tpbnd_expnl.Position(4)-cnd_tpbnd_inpnl.Position(4);
    cnd_tpbnd_inpnl.Position = [0 pnl_pos 0 0];
    cnd_tpbnd_scrll_sldr.Visible = 'Off';
end
function cnd_tpbnd_addimf_pshbttn_callback(~, ~, ~)
%%
global tp_imf_val tp_mt_val cnd_tpbnd_remimf_pshbttn...
    cnd_tpbnd_scrll_sldr cnd_tpbnd_inpnl...
    cnd_tpbnd_msstrns_txt cnd_tpbnd_msstrns_mn1...
    cnd_tpbnd_addmt_pshbttn cnd_tpbnd_remmt_pshbttn...
    cnd_tpbnd_outtmptimep_txt cnd_tpbnd_outtmptimep_edt1...
    cnd_tpbnd_outtmptimep_edt2...
    ...
    cnd_tpbnd_absrpmd_txt cnd_tpbnd_absrpmd_mn...
    cnd_tpbnd_flm_txt cnd_tpbnd_flm_mn...
    cnd_tpbnd_ignmssflx_txt cmpgas_list
%%
if tp_imf_val < size(cmpgas_list,1)
    %%
    if tp_mt_val == 1
        cnd_tpbnd_remimf_pshbttn.Enable = 'on';
        cnd_tpbnd_remimf_pshbttn.Visible = 'On';
    end
...
function cnd_tpbnd_remimf_pshbttn_callback(~, ~, ~)
%%
global tp_imf_val tp_mt_val cnd_tpbnd_scrll_sldr...
    cnd_tpbnd_inpnl cnd_tpbnd_msstrns_txt cnd_tpbnd_msstrns_mn1...
    cnd_tpbnd_addmt_pshbttn cnd_tpbnd_remmt_pshbttn...
    cnd_tpbnd_outtmptimep_txt cnd_tpbnd_outtmptimep_edt1...
    cnd_tpbnd_outtmptimep_edt2...
    cnd_tpbnd_convcoeff1_txt cnd_tpbnd_convcoeff1_edt...
...
if tp_imf_val > 1
    ...
    if tp_imf_val == 1
        cnd_tpbnd_remimf_pshbttn.Enable = 'off';
        cnd_tpbnd_remimf_pshbttn.Visible = 'Off';
    end
    %%
    shift_val = -24;
    ...
    cnd_tpbnd_inpnl.Units = 'normalized';
    cnd_tpbnd_scrll_sldr.Max = cnd_tpbnd_inpnl.Position(4) - 1;
    cnd_tpbnd_inpnl.Position(2) = cnd_tpbnd_scrll_sldr.Min;
    cnd_tpbnd_inpnl.Units = 'pixels';
end
function cnd_tpbnd_scrll_sldr_callback(~, ~, ~)
global cnd_tpbnd_scrll_sldr cnd_tpbnd_inpnl

cnd_tpbnd_inpnl.Units = 'normalized';
cnd_tpbnd_inpnl.Position(2) = -(cnd_tpbnd_scrll_sldr.Value);
cnd_tpbnd_inpnl.Units = 'pixels';
disp(sprintf('%f > %f < %f',cnd_tpbnd_scrll_sldr.Max,...
    cnd_tpbnd_scrll_sldr.Value,cnd_tpbnd_scrll_sldr.Min))

%% ---------------- Conditions Bottom Boundary functions ------------------
function cnd_bttmbnd_msstrns_mn_callback(~, ~, ~)
...
function cnd_bttmbnd_addmt_pshbttn_callback(~, ~, ~)
global bb_mt_val
%% Create New Mass Transport input
cnd_bttmbnd_msstrns_mn2 = findobj(...
...
cnd_bttmbnd_scrll_sldr.Value = 0;
cnd_bttmbnd_inpnl.Units = 'pixels';
function cnd_bttmbnd_remmt_pshbttn_callback(~, ~, ~)
%%
global cnd_bttmbnd_inpnl...
    cnd_bttmbnd_msstrns_txt cnd_bttmbnd_msstrns_mn1...
    bb_mt_val
...
cnd_bttmbnd_scrll_sldr.Value = 0;
cnd_bttmbnd_inpnl.Units = 'pixels';
function cnd_bttmbnd_exrd_mn_callback(~, ~, ~)
%     cnd_bttmbnd_msstrns_mn2_1 cnd_bttmbnd_msstrns_mn3_1...
%     cnd_bttmbnd_msstrns_edt1_1 cnd_bttmbnd_msstrns_edt2_1...
%     cnd_bttmbnd_addmt_pshbttn cnd_bttmbnd_remmt_pshbttn...
%     cnd_bttmbnd_outtmptimep_txt cnd_bttmbnd_outtmptimep_edt1...
...
function cnd_bttmbnd_flm_mn_callback(~, ~, ~)
%     cnd_bttmbnd_msstrns_mn2_1 cnd_bttmbnd_msstrns_mn3_1...
%     cnd_bttmbnd_msstrns_edt1_1 cnd_bttmbnd_msstrns_edt2_1...
%     cnd_bttmbnd_addmt_pshbttn cnd_bttmbnd_remmt_pshbttn...
%     cnd_bttmbnd_outtmptimep_txt cnd_bttmbnd_outtmptimep_edt1...
...
function cnd_bttmbnd_addimf_pshbttn_callback(~, ~, ~)
...
cnd_bttmbnd_inpnl.Position(2) = 0;
cnd_bttmbnd_inpnl.Units = 'pixels';
function cnd_bttmbnd_remimf_pshbttn_callback(~, ~, ~)
global bb_imf_val bb_mt_val
%%
cnd_bttmbnd_ignmssflx_mn = findobj(...
    'Tag',(sprintf('cnd_bttmbnd_ignmssflx_mn_%d',bb_imf_val)));
...
cnd_bttmbnd_inpnl.Position(2) = 0;
cnd_bttmbnd_inpnl.Units = 'pixels';
function cnd_bttmbnd_scrll_sldr_callback(~, ~, ~)
...
global objstrct_figure objstrct_layer_pnl...
    ...
    active_layer_id layer_count objstrctVal

if objstrctVal == 2
    objstrct_figure.Visible = 'On';
elseif objstrctVal == 0
    ...
    objstrct_figure = figure(...
        ...
        'CloseRequestFcn',@objstrct_pshbttn_closereq,...
        'Tag','objstrct_figure',...
        'Visible','on');
...
%% Loop to identify the current mass fraction
...
function objstrct_pshbttn_closereq(~, ~, ~)
global objstrct_figure objstrctVal
objstrctVal = 0;
delete(objstrct_figure);

function objstrct_crte_pshbttn_callback(~, ~, ~)
global objstrct_figure objstrctVal
objstrct_figure.Visible = 'Off';
objstrctVal = 2;


function cnd_crte_pshbttn_callback(~, ~, ~)
%% Top Boundary
...
elseif cnd_tpbnd_exrd_mn.Value == 2;
    for i = tp_mt_val+13:tp_mt_val+16
...
elseif cnd_tpbnd_flm_mn.Value == 2;
    for i = tp_mt_val+19:tp_mt_val+tp_imf_val+22
        OBJ_BOUND{i,1} = ' ';
    end
end
...
for all_lc = 1:layer_count
    ...
    for all_mfc = 1:mass_frac_count_x(all_lc);
        ...
        masf_mn = objstrct_massfrac_mn.String{objstrct_massfrac_mn.Value};
...
if ~(gcf == findobj('Tag','cnd_custom_fig'))
    delete(objstrct_figure)
end
%% $$$$$$$$$$$$$$$$$$$$$$$ THERMAKIN2D $$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$
% function tk2d_button_Callback(~, ~, ~)
%% $$$$$$$$$$$$$$$$$$$$$$$$$ OUTPUT GUI $$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$
%This callback creates output figure when output button is clicked
% function out_button_Callback(~, ~, ~)
...
%             if cnd_created == 0 && tk2d_created == 0 && out_created == 0
%                 cmp_created = 0;
%             elseif tk2d_created == 0 && out_created == 0
%                 cnd_created = 0;
%             elseif out_created == 0
%                 tk2d_created = 0;
%             else
%                 out_created = 0;
%             end
